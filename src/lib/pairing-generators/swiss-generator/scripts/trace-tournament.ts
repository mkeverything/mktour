 ...
 *
 * Usage: bun src/lib/pairing-generators/swiss-generator/scripts/trace-tournament.ts [seed]
 */
...
import { findConnectedComponents } from '@/lib/pairing-generators/swiss-generator/scripts/graph-analysis';
import {
  EdgePair,
  EntityDisplayMap,
  GraphAnalysis,
