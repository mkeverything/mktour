...
import { generateCombinations } from '@/lib/pairing-generators/swiss-generator/alterations';
import { maximumMatching } from '@/lib/pairing-generators/swiss-generator/matching';
import { compareByScore } from '@/lib/pairing-generators/swiss-generator/ordering';
import type {
  C8ContextInfo,
  C8MinDownfloatersInfo,
  CompatibilityGraphInfo,
} from '@/lib/pairing-generators/swiss-generator/pairing-logger';
import {
...
import {
  ...
  TOPSCORER_THRESHOLD,
  WHITE_COLOUR_CHANGE,
} from '@/lib/pairing-generators/swiss-generator/constants';
import {
  didDownfloat,
  didUpfloat,
