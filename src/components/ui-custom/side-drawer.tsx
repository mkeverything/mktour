    ...
    >
      <Drawer.Portal>
        ...
        <Drawer.Content
          ...
          className="bg-background border-l-muted fixed top-0 right-0 bottom-0 z-50 h-dvh max-h-dvh w-auto rounded-l-3xl border-0 border-l-[.5px] px-4 pt-[calc(1.5rem+env(safe-area-inset-top))] pb-[calc(1.5rem+env(safe-area-inset-bottom))] max-sm:left-[5rem] sm:w-sm"
        >
          <Drawer.Title hidden />
