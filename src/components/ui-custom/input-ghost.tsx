...
function InputGhost({
  ...
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'file:text-foreground placeholder:text-primary selection:bg-primary selection:text-primary-foreground dark:bg-background focus-visible:placeholder:text-muted-foreground max-w-full min-w-0 shrink rounded-md bg-transparent text-ellipsis whitespace-pre shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed',
