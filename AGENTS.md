...
- numbered migrations and their metadata are always generated by drizzle from the ts schemas; never write or edit them manually
- all manually applied sql belongs in a separate temporary location outside the numbered migration directory; never embed backfills, guards or operator instructions in generated migrations
